...
CREATE INDEX medical_history_id_treatments_history_asc ON treatments_history(medical_history_id ASC);

CREATE INDEX treatment_id_treatments_history_asc ON treatments_history(treatment_id ASC);
